...
public class CustomizedSingleModule extends SingleModule {
     ...
     * 返回map
     * */
    public Map<String, List<String>> getAllVersionsOfAllLib(){
    ...
    public List<List<Dependency>> getCustomizedUpgradeSolutions(String projectPath, int type,
        ...
        // 有冲突，推荐无冲突版本
        customizedSingleModuleUpgrade(dependencySet);
        // 对升级后的结果集进行有无冲突的判断
        conflictDetectAfter();
    ...
    public void customizedSingleModuleUpgrade(List<Dependency> dependencySet) {
